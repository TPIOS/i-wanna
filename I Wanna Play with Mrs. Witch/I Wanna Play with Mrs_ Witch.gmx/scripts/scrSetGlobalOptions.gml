...
//global.startRoom = r_start;

//global.startRoom = rWJRoom_1;
//global.startRoom = rJushiBig;
//global.startRoom = rQ3;
//global.startRoom = rZoulvRoom_1;
global.startRoom = rMainHub;
...
//hallo only
//6 stage + boss = 7
//but others are 8, so set 8
global.levelItemTotal = 8;
...
//hallo only
global.autosaveLevelItems = true; //sets whether to save secret items immediately when you grab them or if you have to hit a save
