...
global.roomCaptionDef = "I Wanna Play With Mr. Zombie";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rJushiED;    //sets which room to begin with
...
global.secretItemTotal = 100;     //sets how many secret items for the game to save/load
global.bossItemTotal = 1000;       //sets how many boss items for the game to save/load
...
//Added
global.autosaveLevelItems = true;
//6 gimmick + 1 needle rush + 1 boss, as large as it may be, set to 10
global.levelItemTotal = 10;
