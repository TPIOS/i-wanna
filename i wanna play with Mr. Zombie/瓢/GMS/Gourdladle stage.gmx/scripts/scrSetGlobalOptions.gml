...
global.roomCaptionDef = "Gourdladle stage";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rStage02;    //sets which room to begin with
