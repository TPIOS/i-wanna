//flower(n,number,speed,object,x,y,dir)
//���仨�ε�Ļ�Ľű�
//n: ���仨�ε�Ļʱ��ͼ�ζ���������СΪ3��
//number: ͼ��ÿ���ߵĵ�Ļ����
//speed: ��Ļ�ٶ�
...
for (k = 0; k < argument0; k += 1)
{
    ...
    for (i = 0; i < argument1; i += 1)
    {
        ...
        idx[k,i].speed = argument2*point_distance(argument4,argument5,argument4+COS[k]+(COS[k+1]-COS[k])*i/argument1,argument5-SIN[k]-(SIN[k+1]-SIN[k])*i/argument1)+abs(i-argument1/2)/3;
    idx[k,i].I=i
   idx[k,i].K=k}
}
